...
You can find the most recent version of this guide [here](https://github.com/facebookincubator/create-react-app/blob/master/packages/react-typescripts/template/README.md).
...
* `react-typescripts` is a development dependency in the generated projects (including this one).

You almost never need to update `create-react-app` itself: it delegates all the setup to `react-typescripts`.

When you run `create-react-app`, it always creates the project with the latest version of `react-typescripts` so you’ll get all the new features and improvements in newly created apps automatically.

To update an existing project to a new version of `react-typescripts`, [open the changelog](https://github.com/facebookincubator/create-react-app/blob/master/CHANGELOG.md), find the version you’re currently on (check `package.json` in this folder if you’re not sure), and apply the migration instructions for the newer versions.

In most cases bumping the `react-typescripts` version in `package.json` and running `npm install` in this folder should be enough, but it’s good to consult the [changelog](https://github.com/facebookincubator/create-react-app/blob/master/CHANGELOG.md) for potential breaking changes.

We commit to keeping the breaking changes minimal so you can upgrade `react-typescripts` painlessly.
...
>Note: this feature is available with `react-typescripts@0.2.0` and higher.
...
-    "start": "react-typescripts start",
-    "build": "react-typescripts build",
+    "start-js": "react-typescripts start",
+    "start": "npm-run-all -p watch-css start-js",
+    "build": "npm run build-css && react-typescripts build",
     "test": "react-typescripts test --env=jsdom",
...
>Note: this feature is available with `react-typescripts@0.5.0` and higher.
...
>Note: this feature is available with `react-typescripts@0.2.3` and higher.
...
>Note: this feature is available with `react-typescripts@0.9.0` and higher.
...
>Note: this feature is available with `react-typescripts@0.4.0` and higher.
...
>Note: this feature is available with `react-typescripts@0.3.0` and higher.<br>
...
If you run `npm test` and the console gets stuck after printing `react-typescripts test --env=jsdom` to the console there might be a problem with your [Watchman](https://facebook.github.io/watchman/) installation as described in [facebookincubator/create-react-app#713](https://github.com/facebookincubator/create-react-app/issues/713).
...
If you have ideas for more “How To” recipes that should be on this page, [let us know](https://github.com/facebookincubator/create-react-app/issues) or [contribute some!](https://github.com/facebookincubator/create-react-app/edit/master/packages/react-typescripts/template/README.md)
